...
public class Absentlist_Forenoon_Fragment extends Fragment {
    Api api;
    ...
    private void getForenoonabsent(){
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
        Date c = Calendar.getInstance().getTime();
        String formattedDate = df.format(c);
        attendanceModelList=new ArrayList<>();
        Call<AbsentlisModel> attendanceModelCall = api.getabsentlist(headermap,standardid,formattedDate,"forenoon");
